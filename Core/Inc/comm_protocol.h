...
#define COMM_PROTOCOL_MAX_PAYLOAD       160U
#define COMM_PROTOCOL_FRAME_CHUNKS      16U
#define COMM_PROTOCOL_CHUNK_RGB_BYTES   144U
#define COMM_PROTOCOL_LEDS_PER_CHUNK    48U
